...
from src.usecases.user.wallet.delete_by_id import DeleteWallet
...
async def delete_by_id(
    ...
    try:
        delete_user_usecase = DeleteWallet(wallet_repo)
        output = await delete_user_usecase.execute(wallet_id)
